...
export default async function handler(req, res) {
    ...
    // 1. KONEKSI SUPABASE DARI ENVIRONMENT VARIABLES VERCEL
    ...
    try {
        ...
        // 3. PANGGIL GMAIL API UNTUK AMBIL KODE
        ...
        // Cari 1 email terbaru dari Netflix yang mengandung OTP (disesuaikan query-nya)
        ...
        const snippet = msg.data.snippet; // Berisi cuplikan teks email
        
        // Ekstrak 4 digit angka dari teks email menggunakan Regex
        ...
        // 4. HANGUSKAN TOKEN AGAR TIDAK BISA DIPAKAI LAGI
        await supabase
            .from('netflix_tokens')
            .update({ status: 'hangus' })
            .eq('token', token);

        // 5. KIRIM KODE KE FRONTEND (app.js)
